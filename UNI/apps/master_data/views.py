...
from apps.master_data.models import Department, AccountType, Languages, AgeGroup, Skills, PricingMaster
from apps.master_data.serializers import DepartmentSerializer, AccountTypeSerializer, AgeGroupSerializer, \
    SkillsSerializer
from apps.movies.models import ActorPortfolio, ActorAward, ActorAudition, ActorPayment, PaymentTypeRate
from apps.movies.serializers import ActorPortfolioSerializer, ActorAwardSerializer, ActorAuditionSerializer, \
    ActorPaymentSerializer, GroupSerializer, LanguagesSerializer
